...
class DeepSeqCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x_concat = x_concat.view(-1, 150*10)
...
ckptPATH = resultdir + '/models/Maria_plasmid_full-MSE-seq-no57fil-fold'+str(fold)+'-'+args.date+'.pth'
...
PD.to_csv(resultdir + '/Maria_plasmid_full-MSE-seq-no57fil-fold'+str(fold)+'-'+args.date+'.csv')
