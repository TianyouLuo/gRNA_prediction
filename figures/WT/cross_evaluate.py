...
for af in apply_fold:
    ## test set
    test = pd.read_csv(datadir+'Maria-gRNAs-k562-validation-screen-full-test-fold'+str(af)+'.csv', index_col = False)
    ...
    PD.to_csv(resultdir + '/explore/Maria_plasmid_full-MSE-seq-model'+str(fold)+'-testfold'+str(af)+'.csv')
